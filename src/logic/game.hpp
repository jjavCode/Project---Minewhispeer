...
class Game {
   private:
    ...
    bool siguienteJugada(int** solucion,
                         char** tablero,
                         bool** posiciones,
                         int m,
                         int n) {
    ...
    void destaparCeldas(char** tablero,
                        int** solucion,
                        bool** visible,
                        int y,
                        int x,
   ...
   public:
    Score jugar(string player) {
        ...
        do {
            ...
            switch (opcionJ) {
                case 'j':
                    cout << "Ingrese las coordenadas [fila][columna] que desea "
                            "jugar"
                         << endl;
                    cout << "[fila]:";
                    cin >> fil;
                ...
                case 'm':
                    ...
                    break;
                case 'd':
                    cout << "Ingrese la coordenada de la mina a desmarcar"
                         << endl;
                    cout << "[fila]:";
                    cin >> fil;
                    cout << "[columna]:";
        ...
        } while (vida > 0 and minasMarcadasBien != n and
                 (contadorCasillasDest(booleana, n) - minasMarcadasBien) !=
                     ((n * n) - n));
        ...
        if (vida > 0 and double(end - start) < 600) {
            ...
            if (double(end - start) >= 600) {
                ...
                cout << "No completo el juego en el tiempo de 600 segundos"
                     << endl;
            }
            cout << "________________________________________________" << endl;
            cout << "Perdiste!" << endl;
